...
func (c *Client) CreateArtifact(ctx context.Context, repoName string, name string, readme string, artifactType string, platform string, blob graphql.Upload, arch *string, httpRequestOptions ...client.HTTPRequestOption) (*CreateArtifact, error) {
	vars := map[string]interface{}{
		"repoName":     repoName,
		"name":         name,
		"readme":       readme,
...
func (c *Client) CreateCrd(ctx context.Context, chartName ChartName, name string, blob graphql.Upload, httpRequestOptions ...client.HTTPRequestOption) (*CreateCrd, error) {
	vars := map[string]interface{}{
		"chartName": chartName,
		"name":      name,
		"blob":      blob,
...
func (c *Client) UploadTerraform(ctx context.Context, repoName string, name string, uploadOrURL graphql.Upload, httpRequestOptions ...client.HTTPRequestOption) (*UploadTerraform, error) {
	vars := map[string]interface{}{
		"repoName":    repoName,
		"name":        name,
...
const DoDeviceLoginDocument = `mutation DoDeviceLogin {
	deviceLogin {
		loginUrl
		deviceToken
	}
...
func (c *Client) DoDeviceLogin(ctx context.Context, httpRequestOptions ...client.HTTPRequestOption) (*DoDeviceLogin, error) {
	vars := map[string]interface{}{}

	var res DoDeviceLogin
	if err := c.Client.Post(ctx, "DoDeviceLogin", DoDeviceLoginDocument, &res, vars, httpRequestOptions...); err != nil {
		return nil, err
	}
