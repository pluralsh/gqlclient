...
type ArtifactAttributes struct {
	Arch     *string         `json:"arch,omitempty"`
	Blob     *graphql.Upload `json:"blob,omitempty"`
...
type RepositoryAttributes struct {
	Category                      *Category                     `json:"category,omitempty"`
	DarkIcon                      *graphql.Upload               `json:"darkIcon,omitempty"`
	DefaultTag                    *string                       `json:"defaultTag,omitempty"`
	Description                   *string                       `json:"description,omitempty"`
	Documentation                 *string                       `json:"documentation,omitempty"`
	GitURL                        *string                       `json:"gitUrl,omitempty"`
...
type TerraformAttributes struct {
	...
	Description  *string         `json:"description,omitempty"`
	Name         *string         `json:"name,omitempty"`
	Package      *graphql.Upload `json:"package,omitempty"`
	Version      *string         `json:"version,omitempty"`
}
...
type TestStepAttributes struct {
	Description *string         `json:"description,omitempty"`
	ID          *string         `json:"id,omitempty"`
	Logs        *graphql.Upload `json:"logs,omitempty"`
	Name        *string         `json:"name,omitempty"`
	Status      *TestStatus     `json:"status,omitempty"`
}
